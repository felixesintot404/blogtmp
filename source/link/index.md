...
<script src="https://recaptcha.net/recaptcha/api.js?render=6Lf1cW4jAAAAAFyw5UfKVGrw4zeP6FfAAUvvBm83"></script>
<script>
...
function askFriend (event) {
    ...
    grecaptcha.ready(function() {
          grecaptcha.execute('6Lf1cW4jAAAAAFyw5UfKVGrw4zeP6FfAAUvvBm83', {action: 'submit'}).then(function(token) {
              $.ajax({
                type: 'get',
                cache: false,
                url: url,
